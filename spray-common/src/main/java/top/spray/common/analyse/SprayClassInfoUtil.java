package top.spray.common.analyse;
...
public class SprayClassInfoUtil {
    public static final SprayClassInfoUtil INSTANCE = new SprayClassInfoUtil();
    private SprayClassInfoUtil() {}
    ...
    public static File writeAsJavaFile(String baseDir, String fullClassName, String code) {
        ...
        return FileUtil.writeBytes(code.getBytes(Sprays.UTF_8),
