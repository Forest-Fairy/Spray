...
public interface SprayTypeI18nType extends SprayType {
    ...
    default String typeName() {
        return SprayResourceBundleDef.get(this.i18nClass(TargetType.NAME), this.i18nKey());
    }

    @Override
    default String getDescription() {
        return SprayResourceBundleDef.get(this.i18nClass(TargetType.DESCRIPTION), this.i18nKey());
    }

    default Class<? extends SprayResourceBundleDef> i18nClass(TargetType target) {
