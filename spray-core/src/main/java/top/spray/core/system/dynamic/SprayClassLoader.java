...
import top.spray.common.tools.SprayLooper;
import top.spray.core.system.dynamic.compile.java.SprayJavaClassObject;
import top.spray.core.system.dynamic.compile.java.SprayJavaCompiler;
import top.spray.core.system.dynamic.listener.SprayClassLoaderListener;
...
public class SprayClassLoader extends ClassLoader implements AutoCloseable {
    ...
    public void addClass(SprayJavaClassObject<?> fileObject) {
        ...
        if (fileObject.classObject() == null) {
            ...
            SprayLooper.INSTANCE.loop(this.loaderListeners, listener -> listener.newClassDefined(this, loadedClass));
    ...
    @Override
    public void close() {
        SprayLooper.INSTANCE.loop(new ArrayList<>(this.loaderListeners),
