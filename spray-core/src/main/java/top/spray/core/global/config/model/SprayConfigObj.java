package top.spray.core.global.config.model;

import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.TypeUtil;
import top.spray.core.global.config.i18n.SpraySystemConfigurationComment_i18n;
import top.spray.core.global.config.i18n.SpraySystemConfigurationName_i18n;
...
public class SprayConfigObj<T> {
    ...
    public String getName() {
        return Spray_i18nBundleDef.get(SpraySystemConfigurationName_i18n.class, i18n);
    }

    public String getComment() {
        return StrUtil.format(Spray_i18nBundleDef.get(
