package top.spray.core.global.exception;
 ...
 */
public abstract class SprayException extends RuntimeException implements Spray_i18nBundleDef {
    ...
    protected String toI18n(String message, Object... params) {
        String i18n = message == null ? null :
                Spray_i18nBundleDef.get(this.getClass(), message);
