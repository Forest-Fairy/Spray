package top.spray.engine.plugins.remote.dubbo.exception;
...
public class SprayDubboOperationNotSupportException extends RuntimeException {
    public SprayDubboOperationNotSupportException(String msg) {

    }


    public static final String message_key_name = "operation.unsupported.name";
    public static final String message_key_base = "operation.unsupported.base";


    public static SprayDubboOperationNotSupportException name(String opName) {
        return new SprayDubboOperationNotSupportException(StrUtil.format(
