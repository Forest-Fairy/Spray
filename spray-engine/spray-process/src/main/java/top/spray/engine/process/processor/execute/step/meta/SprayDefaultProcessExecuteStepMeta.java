...
public class SprayDefaultProcessExecuteStepMeta implements SprayProcessExecuteStepMeta {
    ...
    private List<? extends SprayProcessExecuteStepMeta> nextNodes;
    ...
    public SprayDefaultProcessExecuteStepMeta(SprayData metaContainer) {
    ...
    public void setNextNodes(List<? extends SprayProcessExecuteStepMeta> nextNodes) {
    ...
    public List<? extends SprayProcessExecuteStepMeta> nextNodes() {
